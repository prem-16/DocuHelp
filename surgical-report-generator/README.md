# Smart Surgical Report Generator
...
# REQUIRED: Add your OPENROUTER_API_KEY from https://openrouter.ai/keys
# REQUIRED: Add Firebase credentials
```
...
- **VLM/LLM Access**: OpenRouter API (access to GPT-4o, Claude, Gemini, etc.)
...
- Simon (Dataset): simon@example.com
- Anish (VLM): anish@example.com
- Prem (Processing): prem@example.com
- Sanjeev (UI/Reports): sanjeev@example.com
